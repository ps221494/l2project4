                ...
                <div class="h-52">
                    <div class="h-full">
                        <div class="flex max-w-md bg-white shadow-lg rounded-lg overflow-hidden">
                            ...
                            <div class="w-2/3 p-2">
                                <h1 class="text-gray-900 font-bold text-2xl"><?php echo e($pizza->pname); ?></h1>
                                ...
                                <form action="<?php echo e(route('cart.store')); ?>" method="post">
                                    ...
                                    <div class="flex item-center justify-between mt-3">
                                        <h1 class="text-gray-700 font-bold text-xl">€ <?php echo e($pizza->amount); ?></h1>

                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="id" value="<?php echo e($pizza->id); ?>" />
                                        <input type="hidden" name="name" value="<?php echo e($pizza->pname); ?>" />
                                        <input type="hidden" name="price" value="<?php echo e($pizza->amount); ?>" />
...
<div class="hidden border-b sm:block rounded-lg bg-white shadow-lg p-2">
    <div class="">
        ...
        <div class="flex justify-end">
            <a href="<?php echo e(route('cart.list')); ?>" class="px-3 py-2 bg-green-300 text-white text-xs font-bold uppercase rounded">Volgende </a>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\School\leer jaar 2\Project4\l2project4\Laravel\resources\views/guest/index.blade.php ENDPATH**/ ?>