    ...
    <div class="flex justify-center my-6">
        ...
        <div class="flex flex-col w-full p-8 text-gray-800 bg-white shadow-lg pin-r pin-y md:w-4/5 lg:w-4/5">
            ...
            <div class="flex-1">
                ...
                <div>
                    <div class="py-4">
                        <a href="<?php echo e(route('bestelling.create')); ?>" class="px-3 py-2 bg-green-300 text-white text-xs font-bold uppercase rounded">Volgende </a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\School\leer jaar 2\Project4\l2project4\Laravel\resources\views/cart.blade.php ENDPATH**/ ?>